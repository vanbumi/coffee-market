...
export default function OrderSuccessPage() {
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-20 text-center">
        <div className="animate-pulse space-y-4">
          <div className="h-16 w-16 bg-[#2A2A2A] rounded-full mx-auto" />
          <div className="h-8 bg-[#2A2A2A] rounded w-64 mx-auto" />
          <div className="h-4 bg-[#2A2A2A] rounded w-96 mx-auto" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Order ID */}
      <div className="bg-[#1A1A1A] rounded-xl border border-[#2A2A2A] p-6 mb-6 text-center">
        <p className="text-sm text-[#A3A3A3] mb-1">Nomor Pesanan</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-[#1A1A1A] rounded-xl border border-[#2A2A2A] p-6">
          ...
          <div className="mt-4 pt-4 border-t border-[#2A2A2A]">
            <p className="text-sm text-[#A3A3A3]">Metode Pengiriman</p>
        ...
        <div className="bg-[#1A1A1A] rounded-xl border border-[#2A2A2A] p-6">
          ...
          <div className="space-y-1 text-sm">
            <p className="text-[#A3A3A3]">Metode Pembayaran</p>
            <p className="font-semibold text-white">{order.paymentMethod.label}</p>
            <p className="text-[#A3A3A3] mt-3">Status</p>
      ...
      <div className="bg-[#1A1A1A] rounded-xl border border-[#2A2A2A] p-6 mb-8">
        ...
        <div className="border-t border-[#2A2A2A] mt-4 pt-4 space-y-2">
          <div className="flex justify-between text-sm">
            ...
            <span className="font-medium text-white">{formatRupiah(order.summary.subtotal)}</span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-[#A3A3A3]">Biaya Pengiriman</span>
            <span className="font-medium text-white">{formatRupiah(order.summary.shippingCost)}</span>
          </div>
