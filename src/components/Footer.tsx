      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-4">
              <img src="/logo.PNG" alt="Sundara Coffee" className="h-10 w-auto" />
              <div>
                <span className="font-bold text-xl text-gold tracking-wide">Sundara Coffee</span>
                <p className="text-[10px] text-text-secondary -mt-1 tracking-[0.2em] uppercase">Premium Roastery</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-text-secondary text-sm">
              <li className="flex justify-between">
                ...
                <span className="text-text-primary">08:00 - 20:00</span>
              </li>
              <li className="flex justify-between">
                <span>Sabtu</span>
              ...
              <li className="flex justify-between">
                <span>Minggu</span>
                <span className="text-text-primary">10:00 - 16:00</span>
              </li>
            </ul>
            <div className="mt-6">
              <h3 className="font-semibold text-gold mb-4 text-sm tracking-wider uppercase">Ikuti Kami</h3>
              <div className="flex space-x-3">
                <a href="#" className="w-10 h-10 border border-border rounded-lg flex items-center justify-center text-text-secondary hover:bg-gold hover:text-black hover:border-gold transition-all duration-300 group" onClick={(e) => { e.preventDefault(); alert('Instagram: @sundaracoffee'); }}>
                ...
                <a href="#" className="w-10 h-10 border border-border rounded-lg flex items-center justify-center text-text-secondary hover:bg-gold hover:text-black hover:border-gold transition-all duration-300 group" onClick={(e) => { e.preventDefault(); alert('Facebook: Sundara Coffee'); }}>
                  <svg className="h-5 w-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </a>
                <a href="#" className="w-10 h-10 border border-border rounded-lg flex items-center justify-center text-text-secondary hover:bg-gold hover:text-black hover:border-gold transition-all duration-300 group" onClick={(e) => { e.preventDefault(); alert('Twitter/X: @sundaracoffee'); }}>
                  <svg className="h-5 w-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-text-secondary text-sm">
            &copy; 2026 Sundara Coffee by revaktor.com. All rights reserved.
          </p>
